...
#### A guide covering Keras including the applications, libraries and tools that will make you better and more efficient with Keras development.
...
1. [Keras Learning Resources](https://github.com/mikeroyal/Keras-Guide#Keras-learning-resources)

2. [Keras Tools, Libraries, and Frameworks](https://github.com/mikeroyal/Keras-Guide#Keras-tools-libraries-and-frameworks)

3. [Algorithms](https://github.com/mikeroyal/Keras-Guide#Algorithms)

4. [Machine Learning](https://github.com/mikeroyal/Keras-Guide#machine-learning)

5. [Deep Learning Development](https://github.com/mikeroyal/Keras-Guide#Deep-Learning-Development)

6. [Reinforcement Learning Development](https://github.com/mikeroyal/Keras-Guide#Reinforcement-Learning-Development)

7. [Computer Vision Development](https://github.com/mikeroyal/Keras-Guide#computer-vision-development)

8. [Natural Language Processing (NLP) Development](https://github.com/mikeroyal/Keras-Guide#nlp-development)

9. [Distributed Computing](https://github.com/mikeroyal/Keras-Guide#distributed-computing)

10. [Parallel Computing](https://github.com/mikeroyal/Keras-Guide#parallel-computing)

11. [CUDA Development](https://github.com/mikeroyal/Keras-Guide#cuda-development)

12. [MATLAB Development](https://github.com/mikeroyal/Keras-Guide#matlab-development)

13. [Python Development](https://github.com/mikeroyal/Keras-Guide#python-development)

14. [C/C++ Development](https://github.com/mikeroyal/Keras-Guide#cc-development)

15. [Scala Development](https://github.com/mikeroyal/Keras-Guide#scala-development)

16. [R Development](https://github.com/mikeroyal/Keras-Guide#r-development)

17. [Julia Development](https://github.com/mikeroyal/Keras-Guide#julia-development)


# Keras Learning Resources
[Back to the Top](https://github.com/mikeroyal/Keras-Guide#table-of-contents)
...
[Train deep learning Keras models | Azure Machine Learning](https://docs.microsoft.com/en-us/azure/machine-learning/how-to-train-keras)

[Top Keras Courses Online | Coursera](https://www.coursera.org/courses?query=keras)

[Top Keras Courses Online | Udemy](https://www.udemy.com/topic/Keras/)

[Learn Keras with Online Courses and Classes | edX](https://www.edx.org/learn/keras)

[Deep Learning Fundamentals with Keras | edX](https://www.edx.org/course/deep-learning-fundamentals-with-keras)

[Deep Learning Course (with Keras & TensorFlow) Certification Training | Simplilearn](https://www.simplilearn.com/deep-learning-course-with-tensorflow-training)
...
# Keras Tools, Libraries, and Frameworks
[Back to the Top](https://github.com/mikeroyal/Keras-Guide#table-of-contents)

[KerasTuner](https://keras.io/keras_tuner/) is an easy-to-use, scalable hyperparameter optimization framework that solves the pain points of hyperparameter search. It comes with Bayesian Optimization, Hyperband, and Random Search algorithms built-in, and is also designed to be easy for researchers to extend in order to experiment with new search algorithms.

[Keras Preprocessing](https://github.com/keras-team/keras-preprocessing) is the data preprocessing and data augmentation module of the Keras deep learning library. It provides utilities for working with image data, text data, and sequence data.

[AutoKeras](http://autokeras.com/) is an AutoML library for Deep Learning based on Keras. It is developed by [DATA Lab](https://faculty.cs.tamu.edu/xiahu/index.html) at Texas A&M University.

[Keras NLP](https://github.com/keras-team/keras-nlp) is an industry-strength Natural Language Processing workflows with Keras.

[Keras CV](https://github.com/keras-team/keras-cv) is an industry-strength Computer Vision workflows with Keras.
...
- [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/Keras-Guide/pulls).
